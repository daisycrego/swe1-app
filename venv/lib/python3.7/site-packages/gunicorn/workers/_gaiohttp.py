...
class AiohttpWorker(base.Worker):
    ...
    def wrap_protocol(self, proto):
        proto.connection_made = _wrp(proto, proto.connection_made, self.connections)
    ...
    def _run(self):
        for sock in self.sockets:
            ...
            self.servers.append((yield from self._create_server(factory, sock)))
        ...
        try:
            while self.alive or self.connections:
                ...
                if self.alive and pid == os.getpid() and self.ppid != os.getppid():
    ...
    def _create_server(self, factory, sock):
        return self.loop.create_server(factory, sock=sock.sock, ssl=self.ssl_context)
