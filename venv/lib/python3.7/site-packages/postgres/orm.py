...
class ReadOnly(Exception):
    def __str__(self):
        return (
            "{} is a read-only attribute. Your Model should implement "
...
class UnknownAttributes(Exception):
    def __str__(self):
        return "The following attribute(s) are unknown to us: {}.".format(
            ", ".join(self.args[0])
        )
...
class NotBound(Exception):
    def __str__(self):
        return (
            "You have to set {}.typname to the name of a type in your "
...
class NotRegistered(Exception):
    def __str__(self):
        return "You have to register {} with a Postgres instance.".format(
            self.args[0].__name__
        )
